...
function Aboutme() {
  ...
  return (
      ...
      <div className={styles.Aboutme} style={{ backgroundImage: `url("./green.svg")`}}>
         <div>
         <img class="animate__animated animate__backInRight" src="./jess.png" alt="Jessica-Vitanza" /><p class="animate__animated animate__backInDown">
         Ciao! Mi chiamo <span>jessica vitanza</span>,<br />
          Sono nata a Palermo il 28/07/1995 e attualmente vivo in Liguria a Cairo Montenotte (SV). <br/>
            ...
            Sono una persona socielove, lavoro bene in gruppo e tendo a volere il controllo della situazione senza perdere nessun dettaglio.
          </p>
           </div> 
    ...
    e in generale provo ad avere uno stile di vita che sia il meno inquinante possibile sia in casa che fuori nei mei spostamenti.</p>
      </div>
